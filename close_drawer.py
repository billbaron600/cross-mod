...
#Specify key paths
configuration_path = "close_drawer_initial_demos.json"
path_to_config_pickle = "run_results/close_drawer/demos/config_instance.pkl"
task = CloseDrawer
results_path = "run_results/close_drawer/demos/"
...
full_limit_to_correction_indices = [20]


#Fail  seesd: [3,5,14,15,19]


shift_mean = np.array([0.0,0.0,0]) #slight shift to the mean
min_vals = np.array([-10.0,-10.0,0.77]) #min xyz values in the bounding box. Just dont have waypoitns outside this
